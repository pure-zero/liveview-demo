        ...
        <div class="mx-auto max-w-4xl p-4 sm:p-6">
          <div class="mb-8 text-center">
            <h1 class="text-3xl sm:text-4xl font-bold mb-4">
              <span class="theme-purple-primary">Submit Your</span> <span class="text-white">Solution</span>
            </h1>
          ...
          <div class="bg-gray-800 rounded-lg border border-gray-700 p-6 shadow-xl">
            ...
            >
              <div>
                <label class="block text-sm font-medium theme-purple-primary mb-2">
                ...
                <textarea
                  ...
                  class="w-full bg-gray-700 border-gray-600 text-white placeholder-gray-400 theme-purple-focus rounded-md"
                  required
              ...
              <div class="flex justify-center">
                <button
                  type="submit"
                  disabled={@loading}
                  class="inline-flex items-center px-8 py-3 text-lg font-semibold rounded-lg theme-purple-gradient text-white theme-purple-gradient-hover disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg"
                >
                  <%= if @loading do %>
          ...
          <%= if @judgment_result do %>
            <div class="mt-8 bg-gray-800 rounded-lg border border-gray-700 p-6 shadow-xl">
              <div class="text-center mb-6">
                <h2 class="text-2xl font-bold theme-purple-primary mb-4">Judgment Results</h2>
              ...
              <div class="bg-gray-700 rounded-lg p-4">
                <h3 class="text-lg font-semibold theme-purple-primary mb-2">Feedback:</h3>
